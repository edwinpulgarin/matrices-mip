...
\begin{frame}{Valoración: de precios de comprador a básicos (Cap.\,7)}
  ...
  \hb{These differences must be eliminated either by proportional adjustments\ldots} (\S7.76) \\[2pt]
  Origen: \hb{the import proportionality or comparability assumption\ldots imports are used in the same proportion across all industry intermediate inputs and final uses} (\S8.33), a usar \hb{only after direct information about import use has been compiled} (\S8.38). \\[2pt]
